...
class TradeView extends StatelessWidget {
  const TradeView({super.key, required this.coinId});
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Highest 24h Price: \$${coin.high24h}',
                          style:
                              TextStyle(fontSize: 16, color: Colors.white70)),
                      Text('Lowest 24h Price: \$${coin.low24h}',
                          style:
                              TextStyle(fontSize: 16, color: Colors.white70)),
                      Text('Last Update: ${coin.lastUpdated}',
                          style:
                              TextStyle(fontSize: 16, color: Colors.white70)),
                    ],
                  ),
                    ...
                    children: [
                      Text('More Information',
                          style: TextStyle(
                              ...
                              color: Colors.lightBlueAccent)),
                      SizedBox(height: 10),
                      Text('Market Volume: ${coin.totalVolume}',
                          style:
                              TextStyle(fontSize: 16, color: Colors.white70)),
                      Text('Market Cap: ${coin.marketCap}',
                          style:
                              TextStyle(fontSize: 16, color: Colors.white70)),
                      Text('Change (24h): ${coin.priceChangePercentage24h}%',
                          style:
                              TextStyle(fontSize: 16, color: Colors.white70)),
                    ],
                  ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Circulating Supply: ${coin.circulatingSupply}',
                          style:
                              TextStyle(fontSize: 16, color: Colors.white70)),
                      Text('Total Supply: ${coin.totalSupply}',
                          style:
                              TextStyle(fontSize: 16, color: Colors.white70)),
                      Text('Max Supply: ${coin.maxSupply}',
                          style:
                              TextStyle(fontSize: 16, color: Colors.white70)),
                      Text('All Time High: \$${coin.ath}',
                          style:
                              TextStyle(fontSize: 16, color: Colors.white70)),
                      Text('ATH Change %: ${coin.athChangePercentage}%',
                          style:
                              TextStyle(fontSize: 16, color: Colors.white70)),
                      Text('All Time Low: \$${coin.atl}',
                          style:
                              TextStyle(fontSize: 16, color: Colors.white70)),
                      Text('ATL Change %: ${coin.atlChangePercentage}%',
                          style:
                              TextStyle(fontSize: 16, color: Colors.white70)),
                    ],
                  ),
